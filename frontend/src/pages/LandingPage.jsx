...
const LandingPage = () => {
  ...
  return (
    ...
    <div className='w-full min-h-full bg-[#FFFCEF] '>
        ...
        <div className='container mx-auto px-4 pt-6 pb-[200px] relative x-10'>
            {/* {header} */}
            ...
            <div className='flex flex-col md:flex-row items-center'>
                <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
                    ...
                    <h1 className="text-5xl text-black font-medium mb-6 leading-right">
                ...
                <div className="w-full md:w-1/2">
                    <p className="text-[17px] text-gray-900 mr-0 md:mr-20 mb-6">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque, laudantium provident qui eum repellendus adipisci. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eius, sit odio aliquam unde quos sint, repellat, iusto impedit molestias doloribus est vero nam officia deserunt itaque suscipit laudantium. Porro, veritatis!
                    </p>
